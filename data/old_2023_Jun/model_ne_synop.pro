...
; into helicentric-cartesian coord.
...
pro model_ne_synop, dens, Ri, nemap, lat=lat, lon=lon, quiet=quiet,iw=iw,name=name,sm=sm, crname=crname
...
;-
 ...
 lon=findgen(360)
 lon=rebin(reform(lon,360,1), 360,181)
 lat=findgen(181)-90.
 lat=rebin(reform(lat,1,181), 360,181)
